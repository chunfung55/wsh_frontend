...
export default function WhoWeAre() {
    return (
        <Box>
            <Image src={slogan1.src} width='100%' height="auto" vertical-align="middle"></Image>
            <Box sx={{ pt: '100px' }}>
            ...
            <Box sx={{ pb: '100px' }}>
                    ...
                    <Grid md={12} container>
                        <Grid md={12} item>
                            <Box className={styles.item15}>
                                <Image src={slogan2.src} width='100%' height="auto" vertical-align="middle" style={{ maxWidth: '1200px' }}></Image>
                            </Box>
                        </Grid>
                    </Grid>
                </Container>
                ...
                <Container maxWidth="false" sx={{ maxWidth: '85%' }}>
                    <Grid md={12} container>
                        <Grid md={12} item>
                            <Box className={styles.item15}>
                                <Image src={slogan3.src} width='100%' height="auto" vertical-align="middle" style={{ maxWidth: '1200px' }}></Image>
                            </Box>
                        </Grid>
                    </Grid>
                </Container>
