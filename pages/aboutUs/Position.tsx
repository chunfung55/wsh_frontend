                    ...
                    <Grid container md={12}>
                        <Grid item md={12}>
                            <Box className={styles.item15}>
                                <Typography className={styles.position_font}>Wildlife in danger…….result of poaching!<br></br>
                                    ...
                                    1215 rhinos were killed in 2014</Typography>
                            </Box>
                        </Grid>
                        <Grid item md={6}>
                            <Box className={styles.item15}><Image src={image1.src}></Image></Box>
                        </Grid>
                        <Grid item md={6}>
                            <Box className={styles.item15}><Image src={image1.src}></Image></Box>
                        </Grid>
