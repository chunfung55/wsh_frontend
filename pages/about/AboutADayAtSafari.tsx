        ...
        <Box>
            ...
            <Box className={styles.item15}>
                    ...
                    <Box className={styles.h1_title}>
                            <Grid justifyContent="top" md={12}>  <Typography className={styles.big_title_font}>A day at Safari</Typography></Grid>
                        </Box>
                        <Box className={styles.h1_about}>
                            <Grid justifyContent="top" md={12}>  <Typography className={styles.p2}>Your days are well-designed to thrill you with intimate wildlife encounters and ensure that guests enjoy a comfortable experience. Here is what you shall expect a day to be in a safari camp.</Typography></Grid>
                        </Box>
                    </Box>
                </Box>
            <Box>
            {contents.map((con) => (
            <Box sx={{padding:"10px"}}>
              <DayAtSafiContent title={con.title} content={con.content} img={con.imgUrl}></DayAtSafiContent>
              </Box>
            ))}
            </Box>
            </AboutFrame>
