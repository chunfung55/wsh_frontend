...
const termsItem = [{img:'https://images.unsplash.com/photo-1516802273409-68526ee1bdd6',url:'',title:'Disclaimer - Privacy Policy',content:'Important information regarding our company policy and booking terms.'}]
    ...
    return (
        <Box>
          ...
          <Container>
            ...
            {termsItem.map((item) => (
              <TermAConItem img={item.img} url={item.url} title={item.title} content={item.content}></TermAConItem>
            ))}
            </Grid>
            
            </Container>
            <Container maxWidth="false" sx={{ maxWidth: '85%' }}><Box className={styles.item15}><BigDivider></BigDivider></Box></Container>
