            ...
            <Grid container sx={{ p: "20px 15px 0px" }}>
              ...
              >
                  ...
                  <Grid container md={12}>
                    ...
                    <Grid item md={9.5}>
                      <Typography className={styles.contact_right_p}>
                        ...
                        room in Causeway Bay during the process. （In view of
                        the latest situation of the COVID-19 epidemic, we
                        implement Work-from-home arrangement for our staffs,
                        kindly make an appointment with us before you visit,
                        thank you）
                      </Typography>
                    </Grid>
                  </Grid>
                ...
                <Grid container md={12} sx={{ p: "0px 15px" }}>
                  <Grid item md={12}>
                    <Typography className={styles.contact_remark}>
                      Our team of passionate and experienced staffs with
                      in-depth Africa knowledge are always here to understand
                      your dreams
                      <br></br>
                      and tailor-made the most inspirational safari of a
