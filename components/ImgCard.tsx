import { Card, CardActionArea, CardMedia, Typography, CardContent, Link, Button, Box, styled } from "@mui/material";
 ...
 export default function ImgCard(cardObj: cardItem)
  ...
  return (
    <Box className={styles.item} >
      ...
      <Card className={styles.card_img} sx={{ borderRadius: '16px',boxShadow:0}}>
      <CardActionArea href={cardObj.href}>
        ...
        <CardContentNoPadding>
          ...
          <Box className={styles.card_footer}>
            ...
            <Button className={styles.img_content_button} sx={{ textTransform:"none", borderRadius:"none", "&.MuiButtonBase-root:hover": {
                bgcolor: " hsla(42, 37%, 64%, .8)"
              }}} disableRipple>{cardObj.price}</Button>
          </Box>
