      ...
      <Grid container md={12} sx={{ p: "20px", backgroundColor: "#D0C09A" }}>
          ...
          <Grid container md={12} className={styles.item15}>
            ...
            <Grid item md={12}>
              <Box className={styles.contact_card_col}>
                <TextField id="Name" label="Name" variant="outlined" autoFocus fullWidth />
              </Box>
            </Grid>
            <Grid item md={12} >
            ...
            <Grid item md={12}>
              <Box className={styles.contact_card_col}>
                <TextField id="Name" label="Email" variant="outlined" autoFocus fullWidth />
              </Box>
            </Grid>
            <Grid item md={12} >
            ...
            <Grid item md={12}>
              <Box className={styles.contact_card_col}>
                <TextField id="Name" label="Telephone Number" variant="outlined" autoFocus fullWidth />
              </Box>
            </Grid>
            <Grid item md={12} >
        ...
        <Grid item md={6} className={styles.item15}>
          <Grid container md={12} className={styles.item15}>
            ...
            <Grid item md={12}>
              <Box className={styles.contact_card_col}>
                <TextField id="Number" label="Number" variant="outlined" autoFocus fullWidth />
              </Box>
            </Grid>
            <Grid item md={12} >
